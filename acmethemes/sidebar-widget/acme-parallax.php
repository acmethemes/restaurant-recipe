 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Restaurant_Recipe_Feature' ) ) {

	class Restaurant_Recipe_Feature extends WP_Widget {
		...
		function __construct() {
			parent::__construct(
                    ...
                    esc_html__('AT Feature Section', 'restaurant-recipe'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Parallax Section.', 'restaurant-recipe' )
                    )
			);
		}
	...
	} // Class Restaurant_Recipe_Feature ends here
}