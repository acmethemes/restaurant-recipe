...
$description = sprintf( esc_html__( '%1$sAdd Popup Widget from here%2$s ', 'restaurant-recipe' ), '<a class="at-customizer" data-section="sidebar-widgets-popup-widget-area" style="cursor: pointer">','</a>' );
$wp_customize->add_control(
	new Restaurant_Recipe_Customize_Message_Control(
		$wp_customize,
